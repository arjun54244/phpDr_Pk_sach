...
<!-- Mirrored from bluebellbd.net/html/dogri/error.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jan 2024 05:50:07 GMT -->
<head>
   <meta charset="utf-8">
                           ...
                           <nav id="mobile-menu">
                              <ul>
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="submenu">
                                       <li><a href="index.php">Medical Center</a></li>
                                       <li><a href="index-2.php">Diagnostic Center</a></li>
                                       <li><a href="index-3.php">Plastic Surgery</a></li>
                                       <li><a href="index-4.php">Medical Shop</a></li>
                                       <li><a href="index-5.php">Dental Care</a></li>
                                       <li><a href="index-6.php">Health Psychology</a></li>
                                    </ul>
                                 </li>
                                 <li>
                                 ...
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="submenu">
                                       ...
                                       <li class="has-dropdown"><a href="doctor.php">Doctor</a>
                                          <ul class="submenu">
                                             <li><a href="doctor.php">Doctor</a></li>
                                             <li><a href="doctor-2.php">Doctor v2</a></li>
                                             <li><a href="doctor-3.php">Doctor v3</a></li>
                  ...
                  <div class="header-right d-flex align-items-center justify-content-end ">
                     <div class="header-action d-none d-lg-inline-flex gap-3 ">
                        <div class="link-text d-none d-xxl-block">
                           ...
                           <span><a href="tel:+380961381876">+380961381876</a></span>
                        </div>
               ...
               <div class="col-xxl-6 col-xl-6 col-md-6">
                  ...
                  <div class="error-content text-center">
                     <h2 class="section-title">Whoops! This Page got Lost
                        in converstion</h2>
                     <a href="index.php" class="fill-btn">
   ...
   <footer>
               ...
               <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                  <div class="footer-widget footer-col-1">
                     <div class="footer-logo mb-35">
                        <a href="index.php"><img src="assets/imgs/logo/logo-white.svg" alt="image bnot found"></a>
                     </div>
      ...
      <div class="fotter-bottom theme-bg-1 pt-25 pb-25">
         <div class="footer-copyright-text text-center">
            <p class="mb-0">© All Copyright 2023 by <a href="#">DOGRI</a></p>
         </div>
      </div>
   </footer>
   <!-- Footer area end -->
